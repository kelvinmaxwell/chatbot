...
public class previousmanualadapter2 extends RecyclerView.Adapter<previousmanualadapter2.MyViewHolder>
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView question, answer,count;
    ...
    public previousmanualadapter2(Context context, List<get_set> contactList, ContactsAdapterListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.chatmanuallayout2, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.question.setText(""+contact.getQuestion()+" ");

        holder.answer.setText(""+contact.getAnswer()+" ");
        try {
            holder.count.setText("" + String.valueOf(((int) Float.parseFloat(contact.getCount())) / 2) + " " + "requests");
